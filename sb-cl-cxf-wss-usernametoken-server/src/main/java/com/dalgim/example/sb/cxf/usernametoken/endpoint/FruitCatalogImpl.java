package com.dalgim.example.sb.cxf.usernametoken.endpoint;

import com.dalgim.example.sb.cxf.usernametoken.model.Fruit;
 ...
 */
@Service
@WebService(endpointInterface = "com.dalgim.example.sb.cxf.usernametoken.endpoint.FruitCatalog", portName = "FruitCatalogPort",
